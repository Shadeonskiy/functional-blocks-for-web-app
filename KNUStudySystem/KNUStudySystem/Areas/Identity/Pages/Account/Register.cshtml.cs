...
namespace KNUStudySystem.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new AppUser { UserName = Input.FirstName + "_" + Input.LastName, Email = Input.Email, FirstName = Input.FirstName, LastName = Input.LastName };
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirm your email", $"{user.FirstName} {callbackUrl}");
